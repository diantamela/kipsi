# -*- coding: utf-8 -*-
{
    ...
    'depends': ['base', 'hr', 'coconut_receiving', 'hr_attendance'],
    'data': [
        'security/payroll_security.xml',
        'security/ir.model.access.csv',
        'data/payroll_sequence.xml',
        'data/payroll_rmp_sequence.xml',
        ...
        'wizard/hr_payroll_borongan_print_wizard_views.xml',
        'report/paperformat.xml',
        'report/report.xml',
        'report/report_hasil_kerja_borongan_templates.xml',
